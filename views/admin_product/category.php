...
require_once ROOT.'/template/layouts/header_admin.php'; 
    ...
    <div class="container">
        <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Управление <strong>товарами по категории</strong></li>
                </ol>

            
            
            <br>
            <a href="/admin/product/create" class="btn btn-default">Добавить товар</a><br><br>
            ...
            <h3>Список товаров категории "<?php echo $category_name ?>"</h3>
